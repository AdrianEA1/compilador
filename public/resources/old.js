// import Parser from '../scripts/prueba';
var tableTokens = null;
...
function alexico() {
    ...
    // const arbolSintactico = new Parsersd(tokens)
...
function asintacticoo() {
    // console.log(tableTokens)
    const tokens = tablaSimbolos.tabla.map(entry => ({
...
class Parsersd {
    ...
    parseDeclaracion() {
        ...
        if (this.currentToken?.type === "Identificador") {
            ...
            this.match("EQUAL"); // Token "="
            
            if (this.currentToken?.type === "CONST_TYPE") {
