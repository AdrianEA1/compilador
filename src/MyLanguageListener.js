...
export default class MyLanguageListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by MyLanguageParser#singleStatement.
	enterSingleStatement(ctx) {
	}

	// Exit a parse tree produced by MyLanguageParser#singleStatement.
	exitSingleStatement(ctx) {
	}


	// Enter a parse tree produced by MyLanguageParser#blockStatement.
	enterBlockStatement(ctx) {
	}

	// Exit a parse tree produced by MyLanguageParser#blockStatement.
	...
	// Enter a parse tree produced by MyLanguageParser#binaryOperator.
	...
	// Enter a parse tree produced by MyLanguageParser#unaryOperator.
	enterUnaryOperator(ctx) {
	}

	// Exit a parse tree produced by MyLanguageParser#unaryOperator.
